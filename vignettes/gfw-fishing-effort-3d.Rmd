...
bathymetry. The stack functions are still placeholders (stubbed with
`stop("Not yet implemented")`); the vignette is intended to fix the API and
the analytical steps before implementation.
